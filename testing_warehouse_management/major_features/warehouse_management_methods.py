...
def update_purchase_quantity_remain(purchase, export_order_detail_obj):
    """
    Update the import purchase's quantity_remain field
    using the quantity_take field 
    of the new one export_order_detail_obj
    """
...
def FIFO(export_order_obj):
    """
    1. Create ExportOrderDetail object
    2. Update ImportPurchase object's quantity_remain field
    3. Update ExportOrder object's total_order_value field
    """
        ...
        with transaction.atomic():
            ...
            for purchase in import_purchases:
                if purchase.quantity_remain >= quantity_export_remain:
                    # Create ExportOrderDetails object
                    ...
                    # Update export_total_order_value variable
                    # for updating the export_order_obj's total_order_value field
            ...
            # Update the ExportOder object's total_order_value field
            # using the export_total_order_value variable
